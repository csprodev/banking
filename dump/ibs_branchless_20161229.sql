...
Date: 2016-12-29 07:27:00
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for kode_perkiraan
-- ----------------------------
DROP TABLE IF EXISTS `kode_perkiraan`;
CREATE TABLE `kode_perkiraan` (
  `kp_id` int(11) NOT NULL AUTO_INCREMENT,
  `kp_no_kode` varchar(255) DEFAULT NULL,
  `kp_nama` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`kp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of kode_perkiraan
-- ----------------------------
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', 'candrasetiadiwahyu@gmail.com', 'candra', '9f1964f992659f9fcafdf07bed0e47fd', 'candra setiadi wahyu', null, '2016-12-13 00:00:00', null, '2016-12-29 00:34:10', null, 'active', '1ec73b1f9d174197975f17e0412e44ef');
