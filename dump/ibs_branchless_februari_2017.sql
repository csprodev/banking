...
-- ----------------------------
INSERT INTO `master_kredit` VALUES ('1', '0', '1213', '312', '3121', '312', '2131', '312', '12', '0000-00-00', '1', '213', '312', '31', '312', '123', '31', '312');
...
-- ----------------------------
INSERT INTO `master_kredit_log` VALUES ('1', 'INSERT', '2017-01-05 23:09:03', '0', '0', '1213', '312', '3121', '312', '2131', '312', '12', '0000-00-00', '1', '213', '312', '31', '312', '123', '31', '312');
...
CREATE TABLE `master_nasabah` (
  ...
  `mn_nomor_identitas` varchar(255) DEFAULT NULL,
  `mn_foto_nasabah` varchar(255) DEFAULT NULL,
  `mn_foto_ktp` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`mn_id`)
...
-- ----------------------------
INSERT INTO `master_nasabah` VALUES ('1', '00000801017573', 'sss', '', '', 'sim', null, 'ccs', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah` VALUES ('2', '00000901017456', 'sss', '', '', 'sim', null, '', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah` VALUES ('3', '00001001017203', 'ddd', '', '', 'sim', null, 'ddd', 'L', '', '2017-01-15', '0901010', '', null, null);
INSERT INTO `master_nasabah` VALUES ('4', null, null, null, null, null, null, null, null, null, '2017-01-29', '0901010', null, null, null);
...
-- ----------------------------
INSERT INTO `master_nasabah_log` VALUES ('1', 'INSERT', '2017-01-05', '0', '00000101017291', 'safril', 'test', 'test', 'sim', '00000101017291', 'asasa', 'L', 'dada', '2017-01-18', '0901010', null, null, null);
INSERT INTO `master_nasabah_log` VALUES ('2', 'UPDATE', '2017-01-05', '1', '00000101017291', 'safril', 'test', '', 'sim', '00000101017291', 'asasa', 'L', 'dada', '2017-01-18', '0901010', '123', null, null);
INSERT INTO `master_nasabah_log` VALUES ('3', 'INSERT', '2017-01-12', '0', '00000201017371', 'dd', '', '', 'sim', null, '', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('4', 'INSERT', '2017-01-12', '0', '00000301017648', 'dd', '', '', 'sim', null, '', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('5', 'INSERT', '2017-01-12', '0', '00000401017700', 'sss', '', '', 'sim', null, '', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('6', 'INSERT', '2017-01-12', '0', '00000501017109', 'aasaadad', '', '', 'sim', null, '', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('7', 'INSERT', '2017-01-12', '0', '00000601017800', 'sss', '', '', 'sim', null, '', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('8', 'INSERT', '2017-01-12', '0', '00000701017915', 'hh', '', '', 'sim', null, '', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('9', 'INSERT', '2017-01-12', '0', '00000801017573', 'sss', '', '', 'sim', null, 'ccs', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('10', 'INSERT', '2017-01-12', '0', '00000901017456', 'sss', '', '', 'sim', null, '', 'L', '', '2017-01-12', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('11', 'INSERT', '2017-01-15', '0', '00001001017203', 'ddd', '', '', 'sim', null, 'ddd', 'L', '', '2017-01-15', '0901010', '', null, null);
INSERT INTO `master_nasabah_log` VALUES ('12', 'INSERT', '2017-01-29', '0', null, null, null, null, null, null, null, null, null, '2017-01-29', '0901010', null, null, null);
...
-- ----------------------------
INSERT INTO `master_tabungan` VALUES ('1', '123', '21', '32', '31', '121', '213', '2131', 'Rp. 25000', 'Rp. 25000', '0');
...
-- ----------------------------
INSERT INTO `master_tabungan_log` VALUES ('1', 'INSERT', '2017-01-05 23:08:42', null, '0', '123', '21', '32', '31', '121', '213', '2131', 'Rp. 25000', 'Rp. 25000', '0');
...
CREATE TABLE `sys_menu` (
  ...
  `sm_title` varchar(255) DEFAULT NULL,
  `sm_user_id` varchar(11) DEFAULT NULL,
  `sm_is_child` varchar(255) DEFAULT NULL,
  `sm_controller` varchar(255) DEFAULT NULL,
  `sm_icon` varchar(255) DEFAULT NULL,
  `sm_id_parent` varchar(255) DEFAULT NULL,
  `sm_order` varchar(10) DEFAULT NULL,
  `sm_is_parent` varchar(10) DEFAULT NULL,
  `sm_is_active` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`sm_id`)
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1', 'Dashboard', '2', '0', 'index', 'fa fa-dashboard', '', '1', null, null);
INSERT INTO `sys_menu` VALUES ('3', 'Master Nasabah', '2', '1', 'master_nasabah', 'fa fa-circle-o', '11', null, null, null);
INSERT INTO `sys_menu` VALUES ('4', 'Master Tabungan', '2', '1', 'master_tabungan', 'fa fa-circle-o', '11', null, null, null);
INSERT INTO `sys_menu` VALUES ('5', 'Menu', '3', null, 'sys_menu', 'fa fa-book', '', '1', '', null);
INSERT INTO `sys_menu` VALUES ('6', 'Users', '3', null, 'sys_user', 'fa fa-book', null, '2', null, null);
INSERT INTO `sys_menu` VALUES ('7', 'Privilege', '3', null, 'sys_privilege', 'fa fa-book', null, '3', null, null);
INSERT INTO `sys_menu` VALUES ('8', 'Master Nasabah List', '2', '1', 'master_nasabah/list_data', 'fa fa-circle-o', '11', null, null, null);
INSERT INTO `sys_menu` VALUES ('11', 'Registrasi', '2', null, '', 'fa fa-book', null, '', '1', '1');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('2', 'candrasetiadiwahyu@gmail.com', 'candra', '9f1964f992659f9fcafdf07bed0e47fd', 'candra setiadi wahyu', null, '2016-12-13 00:00:00', null, '2017-01-29 11:25:58', null, 'active', 'a0d40b54f6508912dab204f0897fb3e0');
INSERT INTO `users` VALUES ('3', 'backend', 'backend', '9f1964f992659f9fcafdf07bed0e47fd', 'backend', null, '2017-01-15 00:00:00', null, '2017-02-05 13:14:35', null, 'active', '9b93574b03ec05bf1d5ece8a4b9b16d2');
...
CREATE TRIGGER `master_nasabah_log_insert` BEFORE INSERT ON `master_nasabah` FOR EACH ROW BEGIN
	INSERT INTO master_nasabah_log SET
		...
		mn_tanggal_lahir = NEW.mn_tanggal_lahir,
                                     mn_nomor_identitas = NEW.mn_nomor_identitas,
...
CREATE TRIGGER `master_nasabah_log_delete` BEFORE DELETE ON `master_nasabah` FOR EACH ROW BEGIN
  INSERT INTO master_nasabah_log SET
    ...
    mn_nomor_identitas = OLD.mn_nomor_identitas,
