      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>master_nasabah/list"><i class="fa fa-circle-o"></i>List Master Nasabah</a></li>
            <li><a href="<?php echo base_url(); ?>master_tabungan/list_data"><i class="fa fa-circle-o"></i>List Master Tabungan</a></li>
            <li><a href="<?php echo base_url(); ?>master_kredit/list"><i class="fa fa-circle-o"></i>List Master Kredit</a></li>
          </ul>
        </li>
        <li class="treeview">
